...
- Public photo view gains a "Manage this photo" floating button for admins — sits below the fullscreen button, click jumps straight to `/m/photos/<id>` so an operator who spots bad metadata while browsing can fix it on the spot. (closes #427)
