...
- Title bar's Gallery/Statistics dropdown becomes a two-pill segmented control so the alternate view is a one-click affordance — same visual language as the Stats expanded-table modal's Top / By value toggle. (closes #316)
